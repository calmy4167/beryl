...
- 本文件是历史审查记录；当前未完成项以 `product/OPEN_WORK.md` 为准，不把历史缺陷条目重新恢复为活跃任务。
...
- 文件路径：[src/views/ModuleView.vue](../../src/views/ModuleView.vue)、[src/views/CasesView.vue](../../src/views/CasesView.vue)、[src/views/CaseView.vue](../../src/views/CaseView.vue)
...
10. [docs/history/BERYL_DESIGN.md](BERYL_DESIGN.md)
