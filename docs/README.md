...
> 状态：当前入口 · 更新日期：2026-09-07

本页是仓库文档的唯一入口。文档是否仍有约束力，以[文档登记册](product/DOCUMENT_REGISTER.md)为准；文件存在不代表其仍是当前产品规范。

## 先读这五份

1. [产品决策](product/PRODUCT_DECISIONS_2026-08-19.md)：已接受决策、实验假设、废弃方向和变更纪律；包含最新的“为解决问题而学习”稳定决策。
2. [统一产品与体验设计](product/CALMY_UNIFIED_PRODUCT_DESIGN_2026-08-29.md)：产品定位、Attention OS、问题驱动学习、信息架构、页面、AI、Flow、数据边界与路线图的统一总稿。
...
发生冲突时，先遵循产品决策记录，再遵循统一产品与体验设计；旧重设计和领域协议用于补充细节。实现状态必须以代码和可复现验证为证据。本入口及登记册已于 2026-09-07 按最新产品理念重新校准；学习与自律类能力统一服从“现实问题 → 最小必要学习 → 应用验证”，整体回归仍待功能阶段收口后统一执行。
