...
| `Obsidian_calmy/Calmy_产品设计完整整理_2026-09-02.md` | 思想母本 | 长篇设计语料的库内总文档；模块双向同步，但不覆盖已接受产品决策和统一执行总设计 |
...
7. `Obsidian_calmy` 的“总文档”仅表示该 Vault 内部的汇编权威；跨仓库执行仍按“Accepted 产品决策 → 统一产品总设计 → Obsidian 思想母本/模块 → 旧参考”的顺序处理。
