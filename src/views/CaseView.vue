...
<style scoped>
.top { display:flex; align-items:center; gap:10px; margin-bottom:16px; }.title :deep(input) { font-family:var(--font-title,inherit); font-size:1.35rem; font-weight:700; }.phases { display:flex; gap:6px; overflow:auto; margin:16px 0; }.phases button { white-space:nowrap; border:1px solid var(--c-border); background:var(--c-bg-soft); color:var(--c-text-2); padding:8px 12px; border-radius:999px; cursor:pointer; }.phases button.on { color:var(--scene); background:var(--scene-soft); border-color:var(--scene-border-strong); }.workspace { padding:16px; display:flex; flex-direction:column; gap:10px; }.workspace h2 { margin:0; font:700 16px var(--font-title,inherit); }.workspace label { font-size:11px; color:var(--c-text-2); margin-top:4px; }.hint { color:var(--c-text-2); font-size:12px; line-height:1.6; margin:0; }.add { display:flex; gap:8px; }.add :deep(.el-select), .add :deep(.el-input) { flex:1; }.line { display:flex; align-items:center; justify-content:space-between; gap:10px; padding:9px 0; border-bottom:1px solid var(--c-border-soft); font-size:13px; }.right { text-align:right; }.record { padding:12px 0; border-top:1px solid var(--c-border-soft); white-space:pre-wrap; font-size:13px; line-height:1.65; }.record p { margin:5px 0; }.record small { color:var(--c-text-3); font-size:10px; }.conclusion { color:var(--scene); }.empty { padding:50px 0; text-align:center; color:var(--c-text-2); }
</style>
