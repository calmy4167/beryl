...
function LocalCapturePage() {
  ...
  return <div className="capture-gate-page">
    <PageHead eyebrow="记录 · 原文优先" title="先收下来，再决定它是什么" description="原文先安全保存；整理可以延后，判断权一直在你手里。"><span className="load-pill">{loading ? '正在读取…' : `${openCaptures.length} 条等待选择`}</span></PageHead>
