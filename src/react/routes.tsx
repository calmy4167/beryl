...
type AppRouteViews = {
  login: ReactNode; pass: ReactNode; protected: ReactNode; shell: ReactNode; today: ReactNode; cycle: ReactNode; flow: ReactNode; profile: ReactNode; memory: ReactNode; capture: ReactNode; matters: ReactNode; caseRedirect: ReactNode; matterDetail: ReactNode; review: ReactNode; admin: ReactNode; advancedAdmin: ReactNode; calendar: ReactNode; people: ReactNode; library: ReactNode; graph: ReactNode; inbox: ReactNode; tasks: ReactNode; taskBoard: ReactNode; habits: ReactNode; finance: ReactNode; goals: ReactNode; pomo: ReactNode; diary: ReactNode; posts: ReactNode; scene: ReactNode; moduleFallback: ReactNode; fallback: ReactNode
}
  ...
  return <Routes>
    <Route path="/login" element={views.login} /><Route path="/pass" element={views.pass} /><Route element={views.protected}>
      <Route path="/app" element={views.shell}>
        ...
        <Route path="today" element={views.today} /><Route path="cycle" element={lazyView(' Cycle', views.cycle)} /><Route path="flow" element={lazyView(' Flow', views.flow)} />
        <Route path="profile" element={lazyView('我的页面', views.profile)} /><Route path="memory" element={lazyView(' AI 记忆', views.memory)} /><Route path="capture" element={lazyView(' Capture', views.capture)} />
