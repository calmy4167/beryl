  ...
  return <Routes>
    <Route path="/login" element={views.login} /><Route path="/pass" element={views.pass} /><Route element={views.protected}>
      <Route path="/app" element={views.shell}>
        ...
        <Route path="review" element={views.review} /><Route path="future" element={lazyView('未来回望', views.future)} /><Route path="feishu" element={lazyView('飞书工作台', views.feishu)} /><Route path="admin" element={lazyView('设置与同步', views.admin)} /><Route path="admin/advanced" element={lazyView('设置与同步（兼容地址）', views.advancedAdmin)} /><Route path="calendar" element={lazyView('日历', views.calendar)} /><Route path="people" element={lazyView('人物上下文', views.people)} /><Route path="library" element={lazyView('资料库', views.library)} /><Route path="graph" element={lazyView('图谱', views.graph)} />
