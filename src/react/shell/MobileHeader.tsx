...
export function MobileHeader({ directoryOpen, directoryTriggerRef, onNavigate, onSearch, onOpenDirectory }: {
  ...
  return <header className="mobile-header">
    ...
    <div>
      ...
      <Button ref={directoryTriggerRef} className="menu" aria-label="打开功能目录" aria-haspopup="dialog" aria-controls="more-drawer" aria-expanded={directoryOpen} onClick={onOpenDirectory}>功能</Button>
    </div>
  </header>
}
