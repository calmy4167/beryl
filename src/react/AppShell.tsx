...
const meta: Record<string, [string, string]> = { today: ['今日', '今天的行动与状态'], cycle: ['Cycle', '五行流转与当前阶段'], flow: ['Flow', '有限地重新激活内容'], capture: ['Capture', '先记录，再决定如何整理'], board: ['事项看板', '拖动任务，回到现实行动'], feishu: ['飞书工作台', '飞书数据的自定义界面'], matters: ['事项', '正在面对的现实事项'], diary: ['日记', '把生活写下来'], review: ['复盘', '观察发生了什么，再调整下一步'], future: ['未来回望', '提前看看一个选择的不同可能'], habits: ['习惯', '记录身体、状态与日常小行动'], goals: ['目标', '把现实结果与证据写清楚'], library: ['资料', '知识与素材中心'], calendar: ['日历', '按时间查看发生了什么'], people: ['人脉', '关系与上下文'], stats: ['统计', '从事实中看趋势'], memory: ['AI 对我的理解', '记忆分层与判断权'], profile: ['我的', '个人概览与模块入口'], settings: ['设置与同步', '备份、同步与数据迁移'] }
...
export function AppShell() {
  ...
  <Button onClick={() => go('/app/feishu')}>▤ 飞书工作台 · 项目与任务</Button>
  ...
  <Button onClick={() => go('/app/future')}>↗ 未来回望（试验）</Button>
</nav></div></div></div>
