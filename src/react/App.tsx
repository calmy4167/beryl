...
import { AttentionCapturePage, CalendarPage, CyclePage, DiaryPage, FinancePage, FlowPage, GoalsPage, GraphPage, HabitsPage, InboxPage, LegacyAdminHost, LibraryPage, MemoryPage, PeoplePage, PomoPage, PostsPage, ProfilePage, ReactAdminPage, ScenePage, TaskBoardPage, TasksPage } from './lazy-pages'
