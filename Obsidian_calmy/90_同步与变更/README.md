...
> 2026-09-07 全库对齐边界：同步工具只搬运文档与元数据，不裁决产品语义；当前产品方向服从 `docs/product/PRODUCT_DECISIONS_2026-08-19.md`、`docs/product/CALMY_UNIFIED_PRODUCT_DESIGN_2026-08-29.md` 与本库 [[00_总纲与治理/02_为解决问题而学习|为解决问题而学习]]。
